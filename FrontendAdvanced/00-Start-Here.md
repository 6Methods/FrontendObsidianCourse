...
1. **Рекомендованный порядок — Track 1 → Track 2 → Track 3 → Track 4.** Это удобная последовательность, но **жёсткой зависимости между треками нет**:
   - **Track 1 (Deep Frontend)** и **Track 2 (TypeScript Mastery)** независимы друг от друга — можно начать с любого.
   - **Track 3 (Архитектура)** в основном самостоятелен; модуль A3.7 (Data fetching, RSC) выигрывает от A1.4, а A3.8 (Design system) — от A2 (typed component API), но не блокируется ими.
   - **Track 4 (Инфра, DevOps, SQL)** опирается на готовое приложение, которое уже умеешь архитектурить — поэтому идёт после Track 3.
...
FSD, monorepo, micro-frontends, legacy, testing, accessibility, data fetching с RSC/Server Actions, design system.
...
- [[A3-Архитектура-и-масштаб/A3.7-Data-fetching-RSC-Actions/00-Обзор-модуля|A3.7 — Data fetching, RSC и Server Actions]]
- [[A3-Архитектура-и-масштаб/A3.8-Design-system/00-Обзор-модуля|A3.8 — Design system]]

### Track 4 — Инфра, DevOps, SQL
Docker, self-hosting без Vercel, CI/CD глубже, SQL, observability, web security, i18n.
...
- [[A4-Инфра-DevOps-SQL/A4.7-i18n/00-Обзор-модуля|A4.7 — i18n]]
...
Tech writing (ADR/RFC/postmortem), senior code review, open source, менторинг, AI-augmented development.
...
- [[A6-Команда-и-культура/A6.5-AI-augmented-development/00-Обзор-модуля|A6.5 — AI-augmented development]]
